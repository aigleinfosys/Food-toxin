...
// UNVERIFIED ON AMB82-MINI: this assumes a 12-bit ADC (0-4095), matching
// the ESP32-S3's analogReadResolution(12). Ameba's ADC bit-depth was not
// confirmed from documentation -- verify with a raw analogRead() test
// against a known voltage before trusting ppm output. Value intentionally
// left unchanged pending that verification.
